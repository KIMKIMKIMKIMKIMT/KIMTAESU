...
namespace Gaa
{
    public class GaaIapResultListener : MonoBehaviour
    {
        ...
        /**
         * launchPurchaseFlow 를 통해 구매에 성공했을 경우 호출됩니다.
         */
        ...
        /**
         * launchPurchaseFlow 를 통해 구매에 실패했을 경우 호출됩니다.
         */
        ...
        /**
         * queryPurchases 를 소비하지 않은 구매정보를 조회에 성공했을 경우 호출됩니다.
         */
        ...
        /**
         * queryPurchases 를 소비하지 않은 구매정보를 조회에 실패했을 경우 호출됩니다.
         */
