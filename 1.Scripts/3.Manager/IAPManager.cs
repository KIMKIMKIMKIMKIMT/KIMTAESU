...
public class IAPManager : DontDestroy<IAPManager>, IStoreListener
{
    ...
    public bool ReleaseAllUnfinishedUnityIAPTransactions()
    {
        foreach (string productId in _productlds)
        {
            Product product = storeController.products.WithID(productId);
            isPurchaseUnderProcess = true;

            if (product != null && product.transactionID != null)
            {
    ...
    {
        bool unfinishedIAPTransaction = ReleaseAllUnfinishedUnityIAPTransactions();
        if (!unfinishedIAPTransaction)
        {
