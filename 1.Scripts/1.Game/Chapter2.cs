...
public class Chapter2 : MonoBehaviour
{
    ...
    private IEnumerator Cor_DefaultWave()
    {
        ...
        while (_time < 300)
        {
            ...
            GeneralEnemySpawn(eENEMY_TYPE.ShortDistanceEnemy1, 3);
            ...
            if (_time == 180)
            {
                for (int i = 0; i < 15; i++)
                {
                    LongDistanceEnemySpawn(eENEMY_TYPE.LongDistanceEnemy1, 3);
                }
            }
        ...
        while (_time < 900)
        {
            ...
            if (_time == 660)
            {
                ...
                for (int i = 0; i < 20; i++)
                {
                    LongDistanceEnemySpawn(eENEMY_TYPE.LongDistanceEnemy2, 3);
                }
